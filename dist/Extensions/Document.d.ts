...
declare function createElement<Tag extends keyof HTMLElementTagNameMap>(this: Document, tagName: Tag, options?: HTMLElementTagNameMap[Tag] | string, ...children: Array<IElement>): HTMLElementTagNameMap[Tag];
